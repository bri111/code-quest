      ...
      case 0:
        return (
          <div className="top-text">
            <h2 align="center">Career as an Information Security Analyst</h2>
            <p align="center" className="fs-5 flex-paragraph">Choose your next step in your information security analysis career.</p>
            <div className="inner-container">
              <div className="box" onClick={() => handleDecision(1)}>
                <p><strong>Network Security - </strong>
                  Focus on securing network infrastructure and preventing cyber attacks.
                </p>
              </div>
              <div className="box" onClick={() => handleDecision(2)}>
                <p><strong>Application Security - </strong>
                  Specialize in securing software applications from vulnerabilities.
                </p>
              </div>
            </div>
          </div>
      ...
      case 1:
        return (
          <div className="top-text">
            ...
            <p align="center" className="fs-5 flex-paragraph">Choose a specialization within network security.</p>
            <div className="inner-container">
      ...
      case 2:
        return (
          <div className="top-text">
            ...
            <p align="center" className="fs-5 flex-paragraph">Choose a focus area within application security.</p>
            <div className="inner-container">
      ...
      case 3:
        return (
          <div className="top-text">
            ...
            <p align="center" className="fs-5 flex-paragraph">Choose a specific aspect of intrusion detection to focus on.</p>
            <div className="inner-container">
      ...
      case 4:
        return (
          <div className="top-text">
            ...
            <p align="center" className="fs-5 flex-paragraph">Choose a specific area of firewall management to specialize in.</p>
            <div className="inner-container">
      ...
      case 5:
        return (
          <div className="top-text">
            ...
            <p align="center" className="fs-5 flex-paragraph">Choose a specific aspect of secure coding to focus on.</p>
            <div className="inner-container">
      ...
      case 6:
        return (
          <div className="top-text">
            ...
            <p align="center" className="fs-5 flex-paragraph">Choose a specific area of vulnerability assessment to specialize in.</p>
            <div className="inner-container">
      ...
      case 7:
        return (
          <div className="top-text">
            ...
            <p align="center" className="fs-5 flex-paragraph">Choose a specific SIEM system to focus on.</p>
            <div className="inner-container">
      ...
      case 8:
        return (
          <div className="top-text">
            ...
            <p align="center" className="fs-5 flex-paragraph">Choose a specific tool for network monitoring.</p>
            <div className="inner-container">
      ...
      case 9:
        return (
          <div className="top-text">
            ...
            <p align="center" className="fs-5 flex-paragraph">Choose a specific focus within firewall policy configuration.</p>
            <div className="inner-container">
      ...
      case 10:
        return (
          <div className="top-text">
            ...
            <p align="center" className="fs-5 flex-paragraph">Choose a specific area of threat analysis to specialize in.</p>
            <div className="inner-container">
      ...
      case 11:
        return (
          <div className="top-text">
            ...
            <p align="center" className="fs-5 flex-paragraph">Choose a specific aspect of code reviews to focus on.</p>
            <div className="inner-container">
      ...
      case 12:
        return (
          <div className="top-text">
            ...
            <p align="center" className="fs-5 flex-paragraph">Choose a specific tool for automated security testing.</p>
            <div className="inner-container">
      ...
      case 13:
        return (
          <div className="top-text">
            ...
            <p align="center" className="fs-5 flex-paragraph">Choose a specific type of penetration testing to specialize in.</p>
            <div className="inner-container">
      ...
      case 14:
        return (
          <div className="top-text">
            ...
            <p align="center" className="fs-5 flex-paragraph">Choose a specific aspect of risk management to focus on.</p>
            <div className="inner-container">
